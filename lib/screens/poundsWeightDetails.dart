...
class PoundsWeightDetails extends StatefulWidget {
  PoundsWeightDetails();

  @override
  _PoundsWeightDetails createState() => _PoundsWeightDetails();
}

class _PoundsWeightDetails extends State<PoundsWeightDetails> {
  //new decimal picker
  ...
  Widget createTable() {
    ...
    for (int i = 0; i < hParameterNotifier.hParameterList.length; i++) {
      if (hParameterNotifier.hParameterList[i].weightPounds != null) {
        listWithNoEmptyRecordsWeightValues.add(hParameterNotifier.hParameterList[i].weightPounds);
